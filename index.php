                ...
                var horizontal_myBarChart = new Chart(horizontal_week_view_sales, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      ...
                      backgroundColor: ["rgba(59, 166, 221, 0.4)", "rgba(172, 104, 110, 0.4)",
                        "rgba(126, 60, 230, 0.4)", "rgba(179, 229, 145, 0.4)", "rgba(239, 60, 246, 0.4)",
                        "rgba(193, 160, 138, 0.4)", "rgba(11, 217, 25, 0.4)"
                      ],
                      borderColor: ["rgba(132, 48, 224, 1)", "rgba(255, 5, 138, 1)", "rgba(95, 9, 176, 1)",
                        "rgba(172, 247, 75, 1)", "rgba(199, 246, 2, 1)", "rgba(147, 246, 11, 1)",
                        "rgba(82, 3, 166, 1)"
                      ],
                      borderWidth: 1
                    }]
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <script>
                ...
                var sales_amount_bar_display = new Chart(sales_amount_bar_chart, {
                  type: 'bar',
                  data: {
                    labels: ['6 Jul 2022', '3 Jul 2022', '10 Jul 2022', '11 Jul 2022', '14 Jul 2022', '16 Jul 2022',
                      '18 Jul 2022', '21 Jul 2022', '22 Jul 2022', '23 Jul 2022',
                    ],
                    datasets: [{
                      label: 'Sales',
                      data: ['0', '0', '290', '0', '3', '22500', '0', '3420', '13580', '6600', ],
                      backgroundColor: [
                        'rgba(57, 234, 133, 0.5)', 'rgba(76, 162, 57, 0.5)', 'rgba(43, 45, 170, 0.5)',
                        'rgba(57, 113, 92, 0.5)', 'rgba(132, 81, 72, 0.5)', 'rgba(149, 183, 2, 0.5)',
                        'rgba(38, 206, 120, 0.5)', 'rgba(170, 129, 136, 0.5)', 'rgba(89, 79, 217, 0.5)',
                        'rgba(102, 23, 210, 0.5)',
                      ],
                      borderColor: [
                        'rgba(240, 220, 21, 1)', 'rgba(171, 121, 67, 1)', 'rgba(124, 245, 224, 1)',
                        'rgba(74, 93, 42, 1)', 'rgba(53, 195, 51, 1)', 'rgba(123, 115, 80, 1)',
                        'rgba(70, 46, 45, 1)', 'rgba(142, 66, 170, 1)', 'rgba(188, 242, 174, 1)',
                        'rgba(66, 187, 109, 1)',
                      ],
                      borderWidth: 1
                    }]
