...
(function () {
        ...
        function Criteria(table, opts, topGroup, index, depth) {
            ...
            this.dom = {
                ...
                conditionTitle: $$2('<option value="" disabled selected hidden/>')
                    .php(this.s.dt.i18n('searchBuilder.condition', i18n.condition)),
                container: $$2('<div/>')
                ...
                dataTitle: $$2('<option value="" disabled selected hidden/>')
                    .php(this.s.dt.i18n('searchBuilder.data', i18n.data)),
        ...
        Criteria.init2Input = function (that, fn, preDefined) {
            ...
            var els = [
                ...
                $$2('<span>')
                    ...
                    .php(that.s.dt.i18n('searchBuilder.valueJoiner', that.c.i18n.valueJoiner)),
                $$2('<input/>')
                    .addClass(Criteria.classes.value)
                    .addClass(Criteria.classes.input)
                    .on('input.dtsb keypress.dtsb', that._throttle(function (e) {
    ...
    var Group = /** @class */ (function () {
        ...
        Group.prototype.rebuild = function (loadedDetails) {
            ...
            this.dom.logic.children().first().php(this.s.logic === 'OR'
        ...
        Group.prototype._setup = function () {
            ...
            this.dom.logic.children().first().php(this.c.logic === 'OR'
                ? this.s.dt.i18n('searchBuilder.logicOr', this.c.i18n.logicOr)
                : this.s.dt.i18n('searchBuilder.logicAnd', this.c.i18n.logicAnd));
        ...
        Group.prototype._toggleLogic = function () {
            if (this.s.logic === 'OR') {
                this.s.logic = 'AND';
                this.dom.logic.children().first().php(this.s.dt.i18n('searchBuilder.logicAnd', this.c.i18n.logicAnd));
            }
            else if (this.s.logic === 'AND') {
                this.s.logic = 'OR';
                this.dom.logic.children().first().php(this.s.dt.i18n('searchBuilder.logicOr', this.c.i18n.logicOr));
            }
        };
        Group.version = '1.1.0';
        Group.classes = {
